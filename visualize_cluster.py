...
def main(args):
	...
	helper.plot_with_labels(p2v.paper_vectors, filename='papers.png', markers=p2v.paper_cluster_ids,
	                        perplexity=args.perplexity)

	# for visualizing, do dim reducing twice
	p2v.reduce_paper_vectors_dim(2, perplexity=args.perplexity)
	p2v.clustering_papers(clusters=args.clusters)
	helper.plot_with_labels(p2v.paper_vectors, filename='papers_r.png', markers=p2v.paper_cluster_ids,
	                        perplexity=args.perplexity)
